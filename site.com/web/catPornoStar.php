<?php include ('../templates/header.html');?>
  ...
  <head>
    <title>Мир SISSY девочек | SHEMALE ЗВЕЗДЫ ПОРНО | worldsissy.com</title>
    <meta name="description" content="Самые знаминитые порно SHEMALE актрисы, которые завоевали миллиарды взглядов мужчин по всему свету.">
    <meta name="keywords" content="sissy star, sissy порно звезды, sissy porn star, Daisy Taylor, shemale star, Natalie Mars, Chanel Santini, Ella Hollywood, Khloe Kay, порно транс звезды, трансы звезды видео">
  </head>
...
?>
  ...
  $active = $page; 
  $count_show_pages = 5;
  $url = "/web/catPornoStar.php";
  $url_page = "/web/catPornoStar.php?page=";
